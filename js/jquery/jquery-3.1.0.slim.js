 ...
 * https://sizzlejs.com/
 *
 * Copyright jQuery Foundation and other contributors 版权jQuery基金会和其他贡献者
...
(function(global, factory) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        // For CommonJS and CommonJS-like environments where a proper `window` CommonJS和CommonJS-like环境中适当的窗口
        // is present, execute the factory and get jQuery. 存在,执行工厂和jQuery吗
        // For environments that do not have a `window` with a `document` 对环境没有“窗口”与“文档”
        // (such as Node.js), expose a factory as module.exports. (如node . js),暴露module.exports工厂。
        // This accentuates the need for the creation of a real `window`. 这强调了需要建立一个真正的“窗口”。
        // e.g. var jQuery = require("jquery")(window); e.g. 如 var jQuery =require("jquery")(window)
